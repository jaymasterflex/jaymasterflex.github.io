...
var questions = ["What is your name?", "Where do you live?", "Are you a man or a woman?", "What have you taken today as breakfast?", "What is your favorite programming language?", "Do you love gaming?", "What's the title of the last book you read?", "Are you married?", "Whom do you love most?", "How many teeth are seen when you smile?"];
var questionsUser = questions.concat(["How do you laugh?"]);
var qAnswers = ["I have no name!", "I don't need any place to live.", "I am a male robot.", "I don't take any meal.", "I love python though I am not programmed in Python.", "Of course I love.", "A robot never reads any book!", "Not yet..", "Of course my creator- Md. Nafis Ul Haque Shifat.", "Probably all.", "Showing all of my teeth..!!"];
var dist = 0;
...
function reply(msg) {
    ...
    else if (msg.startsWith("do you know"))
    {
        ...
        if (contains(msg, "created you") || contains(msg, "is your creator") || contains(msg, "made you") || contains(msg, "made it") || containsItem(["coded you", "programmed you"], msg)) sendMsg("I'm created by Md. Nafis Ul Haque Shifat");

        else if (contains(msg, "are you")) sendMsg("I'm a chatbot containing a lot of if-else statements created by Md. Nafis Ul Haque Shifat.");
    ...
    else if (msg.startsWith("you are"))
    {
        ...
        {
            var possAns = ["That means you are trying to judge me.", "Not sure wheter it is a right observation or not.", "Thanks for the comment."];
            sendMsg(possAns[Math.floor(Math.random() * possAns.length)]);
        }
    ...
    else if (containsWord(msg, "sorry") && (containsWord("i") || wordNum(msg) <= 3))
    {
        ...
        var possAns = ["Didn't understand anything.", "I am just a bot, don't say anything I can't understand.", "Couldn't understand what you meant."]
